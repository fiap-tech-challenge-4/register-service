...
import br.com.register.webui.converters.CustomerConvert;
...
public class CustomerUseCase {
    ...
    public CustomerResponse registerCustomer(CustomerDTO customerDTO) {
        ...
        var entity = CustomerConvert.toEntity(customerDTO);
        var entityResponse = customerRepository.save(entity);
        return CustomerConvert.toCustomerResponse(entityResponse);
    }
    ...
    public CustomerResponse searchCustomerById(Long id) {
        return CustomerConvert.toCustomerResponse(getCustomerById(id));
    }
    ...
    public CustomerResponse searchCustomer(String cpf) {
        ...
        return CustomerConvert.toCustomerResponse(customer);
    }
    ...
    public PaginationResponse<CustomerResponse> listCustomers(Integer page, Integer limit, String sort) {
        ...
        List<CustomerResponse> customersResponse = CustomerConvert.toResponseList(customers.getContent());
